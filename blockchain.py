...
class BlockChain(object):
    ...
    def mine_block(self, miner_address):
        # Sender "0" significa que este nodo ha minado un nuevo bloque
        # Por minar el bloque, debemos recompensar con algún monto (1 en este caso)
        ...
        # Retornamos un objeto nativo de tipo Dict
        return vars(block)
